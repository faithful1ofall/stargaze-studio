...
const HomePage: NextPage = () => {
  return (
    <section className="px-8 pt-4 pb-16 mx-auto space-y-8 max-w-4xl">
      ...
      <h1 className="font-heading text-4xl font-bold">Welcome to Miniutopia Hub!</h1>
      <p className="text-xl">
        Looking for a fast and efficient way to build an NFT collection? Miniutopia Hub is the solution.
        <br />
        <br />
        Miniutopia Hub is built to provide useful smart contract interfaces that help you build and deploy your own NFT
        collections on EVM chains in no time.
      </p>
